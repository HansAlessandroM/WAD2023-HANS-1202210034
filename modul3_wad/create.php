...
// (3) Jika sudah coba deh kalian ambil data dari form (CLUE : pakai POST)
    ...
    $query = mysqli_query ($connect, "INSERT INTO showroom_mobil(nama_mobil, brand_mobil, warna_mobil, tipe_mobil, harga_mobil) VALUES ('$car_name', '$car_brand', '$car_color', '$car_type', '$car_price')");
